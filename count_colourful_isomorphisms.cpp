...
public:
    ...
    {
        return S.find(v) != S.end(); // keep all vertex_descriptors greater than 3
    }
};
...
// */
// int count_colour_preserving_isomorphisms(const Graph& H, const Graph& G, const ColourMap& colour_H, const ColourMap& colour_G) {
